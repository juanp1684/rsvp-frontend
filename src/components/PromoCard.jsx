export default function PromoCard({ className = '' }) {
  return (
    <div className={`w-full max-w-[220px] rounded-2xl border border-[#C0A18F]/40 bg-[#FFF1E9] px-5 py-4 text-center shadow-sm ${className}`}>
      ...
      >
        ...
        ¿Te gustó esta invitación? · Solicita la tuya
      </a>
    </div>
  )
}
