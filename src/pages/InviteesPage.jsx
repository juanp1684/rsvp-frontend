                ...
                {filtered.map((invitee, idx) => (
                  <>
                    {(idx === 0 || filtered[idx - 1].invitation_id !== invitee.invitation_id) && (
                      <TableRow key={`hdr-${invitee.invitation_id}`} className={`border-t-2 border-border ${invitee.type === 'late' ? 'bg-amber-100 dark:bg-amber-950/20 hover:bg-amber-100' : 'bg-slate-200 dark:bg-muted hover:bg-slate-200 dark:hover:bg-muted'}`}>
